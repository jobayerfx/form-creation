...
<div class="card">
    <div class="card-header">
        ...
        <h5 class="card-title">{{ $page }} <span class="badge bg-{{ $symbol['color'] }} rounded-pill">{{ $symbol['label'] }}</span></h5>
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title">{{ $response_count . ' ' . \Illuminate\Support\Str::plural('Response', $response_count) }}</h5>
        <div class="heading-elements">
        </div>
    </div>
</div>

@includeWhen($response_count, "forms.response.individual")
